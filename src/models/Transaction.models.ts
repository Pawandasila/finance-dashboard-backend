...
import { convertToPaisa, convertToRupeesUnit } from "../utils/format-currency";
...
export const TransactionSchema = new Schema<TransactionDocument>(
  {
    ...
    amount: {
      type: Number,
      required: true,
      set: (value: number) => convertToPaisa(value), // 130.89 -> 13089 ( paisa )
      get: (value: number) => convertToRupeesUnit(value), // 13089 -> 130.89 ( rupees )
    },
    description: {
      type: String,
    },
